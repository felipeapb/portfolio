	...
	<?php } ?>
		...
		<?php if(get_theme_option('video') != '') {
			...
			<div class="sidebarvideo">
				<ul> <li><h2 style="margin-bottom: 10px;">Vídeo em Destaque</h2>
		...
		<ul>
			<?php 
				...
				<li><h2><?php _e('Artigos Recentes'); ?></h2>
			               <ul>
				...
				<?php wp_list_categories('hide_empty=0&show_count=0&title_li=<h2>Categorias</h2>&depth=1'); ?>
				...
				<li><h2>Meta</h2>
					<ul>
						...
						<li><a href="http://www.wpthemespt.com/" title="Temas para Wordpress.">WPThemesPT</a></li>
