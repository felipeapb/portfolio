			...
			<div id="myGallery">
				...
				if($featured_posts_category != '' && $featured_posts_category != '0') {
					...
					for($i = 1; $i <=5; $i++) {
						?>
							<div class="imageElement">
								<h3>Este é um artigo em destaque: <?php echo $i; ?></h3>
								<p>Para configurar os artigos em destaque, vá até a página de configuração do tema.</p>
								<a href="#" title="Este é um artigo em destaque: <?php echo $i; ?>" class="open"></a> 
